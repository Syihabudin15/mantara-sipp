            ...
            <div className="flex justify-between border-b border-dashed my-2">
              ...
              <div className="flex gap-2 flex-2">
                ...
                <Input
                  size="small"
                  disabled
                  value={IDRFormat((data.plafond * data.c_adm_sumdan) / 100)}
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="my-4" hidden>
            ...
            <div className="text-xs text-gray-500 italic">
              OCR bisa dilakukan setelah berkas pengajuan diupload, pastikan
              file yang diupload adalah file pengajuan yang benar dan jelas
              untuk hasil OCR yang maksimal.
            </div>
          </div>
        </div>
